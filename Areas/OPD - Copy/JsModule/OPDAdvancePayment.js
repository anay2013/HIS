...
function ReceiptInfo() {
    ...
    var objBO = {};
    objBO.hosp_id = '';
    objBO.UHID = window.parent._IPDNo;
    objBO.IPDNo = window.parent._IPDNo;
    objBO.DoctorId = '';
    objBO.Floor = '';
    objBO.PanelId = '';
                ...
                if (Object.keys(data.ResultSet.Table).length) {
                    ...
                    $.each(data.ResultSet.Table, function (key, val) {
                        ...
                        if (temp != val.ReceiptNo) {
                            ...
                            tbody += "<td colspan='6'><b>Receipt No : </b>" + val.ReceiptNo;
...
function PatientAdvance() {
    if (confirm('Are you sure?')) {
        if ($('#ddlIPOPType option:selected').text() == 'Select') {
            alert('Please Select IPOP Type.');
            return
        }
        ...
        objBooking.IPOPType = $('#ddlIPOPType option:selected').text();
