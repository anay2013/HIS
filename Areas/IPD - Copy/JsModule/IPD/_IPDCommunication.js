$(document).ready(function () {
    ...
    $('#ddlSection option').each(function () {
        if ($(this).text() == _sectionForCommunication)
            $('#ddlSection').prop({ 'selectedIndex': '' + $(this).index() + '', 'disabled': true }).change()
    })
});
...
function UpdateComLog() {
    ...
    objBooking.IPDNo = _IPDNo;
    objBooking.DoctorId = '-';
    objBooking.ipAddress = _sectionForCommunication;
    objBooking.login_id = Active.userId;
