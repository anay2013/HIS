                ...
                if (Object.keys(data.ResultSet.Table).length) {
                    $.each(data.ResultSet.Table, function (key, val) {
                        if (temp != val.PanelName) {
                            ...
                            tbody += "<td colspan='17' style='font-size:13px;'><b>" + val.PanelName + "</b></td>";
                            tbody += "</tr>";
                            temp = val.PanelName
                        }
                        else {
                        ...
                        if (val.IsErrorInCredit == "Y")
                            ...
                            if (val.IsBillLocked == "N") {
                                tbody += "<tr style='background:pink'>";
                            }
                            else if (val.IsBillClosed == "N") {
                                tbody += "<tr style='background:#e95f5fc7'>";
                            }
                            else if (val.IsBillLocked == "Y" && val.IsBillClosed == "Y") {
                                tbody += "<tr style='background:#87dd88'>";
                            }
                            else {
                                tbody += "<tr>";
                            }
                ...
                if (Object.keys(data.ResultSet.Table).length) {
                    $.each(data.ResultSet.Table, function (key, val) {
                        ...
                        if (val.IsBillLocked == "N") {
                            ...
                            tbody += "<tr style='background:#f74141c7'>";
                        }
                        else if (val.IsBillLocked == "Y" && val.IsBillClosed == "Y") {
                            tbody += "<tr style='background:#87dd88'>";
                        }
