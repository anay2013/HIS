...
function GetPatientDetailByIPDNo() {
    ...
    var url = config.baseUrl + "/api/commission/Referral_CommissionQueries";
    var objBO = {};
    objBO.hosp_id = '-';
    ...
    objBO.Logic = "PatientDetailByIPDNo";
    $.ajax({
        method: "POST",
        url: url,
...
function SetReferral() {
    ...
    var url = config.baseUrl + "/api/commission/Referral_InsertCommission";
    var objBO = {};
    objBO.IPDNo = $('#txtIPDNo').val();
...
function SyncProcess() {
    ...
    var url = config.baseUrl + "/api/commission/Referral_CommissionCalculate";
    var objBO = {};
