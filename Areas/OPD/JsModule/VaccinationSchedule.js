...
function ITDOSE_InsertMacData() {
    var url = "http://localhost:50013/api/Lab/ITDOSE_InsertMacData";
    var objBO = [];
    objBO.push({
                    'LabId': "CH01",
                    'VisitNo':"OW-2324-00000646",
                    'BarCodeNo': "45487963",
                    'ObservationId':"1599",
                    'ObservationName': "TSH (THYROID STIMULATING HORMONE)",
                    'MacId': "Mac001",
                    'MacName': "Mac001",
                    'Reading': "96.25",
                    'Unit': "mg/DL",
                    'ResultDateTime': "2023-10-11 10:25",
                    'Logic': "InsertMachineData",
            });
    objBO.push({
                'LabId': "CH01",
                'VisitNo': "OW-2324-00000646",
