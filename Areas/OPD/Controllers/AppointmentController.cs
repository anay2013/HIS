...
namespace MediSoftTech_HIS.Areas.OPD.Controllers
{
	...
	{ 
        ...
        public ActionResult DiagnosticDisplay()
        {
            return View();
        }
        public ActionResult OPDAdvancePayment()
        {
            return View();
        }
        public ActionResult EditPatientDetail()
        {
            return View();
        }
        ...
        public ActionResult PatientRagistrationKiosk()
        {
            return View();
        }
